...
const PRODUCTS = [
  ...
  // ── Photo prints · digital downloads ────────────────────────────────
  { id: 'tp018', title: 'Octopus', sub: 'Wildlife poster · Deep sea', price: 12, category: 'Photo Prints', motif: 'photo-landscape', edition: 'DIGITAL DOWNLOAD', sizes: ['Digital download'], year: 2026, paper: 'High-resolution PNG + PDF', stock: 9999, image: 'images/photo-prints/octopus.jpg', digital: true, badge: 'New' },
  { id: 'tp019', title: 'Tiger', sub: 'Wildlife poster · On the prowl', price: 12, category: 'Photo Prints', motif: 'photo-landscape', edition: 'DIGITAL DOWNLOAD', sizes: ['Digital download'], year: 2026, paper: 'High-resolution PNG + PDF', stock: 9999, image: 'images/photo-prints/tiger.jpg', digital: true, badge: 'New' },
